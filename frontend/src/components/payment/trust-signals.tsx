...
export default function TrustSignals() {
  ...
  return (
    <section id="trustSignals" className="py-20 bg-background relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16 animate__animated animate__fadeIn">
          <h2 className="text-3xl font-bold text-foreground">Why Trust Conversly.ai?</h2>
          <p className="mt-4 text-xl text-muted-foreground">
            Join thousands of businesses that trust us with their customer interactions
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {trustSignals.map((signal, index) => (
            <div
              key={index}
              className="text-center p-6 bg-card rounded-xl shadow-sm animate__animated animate__fadeInUp"
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-2 text-foreground">{signal.title}</h3>
